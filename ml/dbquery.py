...
def fetchall(sql):   #function that executes a query and returns its output/ read data from table
    sql = str(sql)
    db = psycopg2.connect(database = "ddb5e18sfuevd6", user = "yshqknwdqhxmrw", password = "a74c3ed4c7d2f55df2425cc4dae95b35d16b46cdac0f978fd5141d7069823c87", host = "ec2-54-217-235-159.eu-west-1.compute.amazonaws.com", port = "5432")
    cur =db.cursor()
    cur.execute(sql)
    info = cur.fetchall()
    db.close()
